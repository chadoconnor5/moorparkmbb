...
Reads box scores from '2018-19 Teams Schedules/<Team>/' and writes
aggregated stats to '2018-19 Team Statistics/<Team>/'.

Usage:
    python generate_team_stats_2021.py --teams Moorpark Ventura
    python generate_team_stats_2021.py --all
"""
...
SCHEDULES_DIR = Path("2018-19 Teams Schedules")
STATS_DIR = Path("2018-19 Team Statistics")
...
TEAM_ALIASES = {
    ...
    # Additional display-name variants found in 2018-19 box scores
    "College of the Deser": "Desert",
    "Copper Montain": "Copper Mountain",
    "East L.A. Huskies": "East Los Angeles",
    "Imperial College": "Imperial Valley",
    "LATRADET": "LA Trade Tech",
    "Los Angeles Harbor": "LA Harbor",
    "Mira Costa College": "MiraCosta",
    "Mt. S.Jacinto Eagles": "Mt. San Jacinto",
    "Riverside Tigers": "Riverside",
    "SD City": "San Diego City",
...
def compute_game_log(team_name: str, boxscores: list[dict], schedule: dict) -> list[dict]:
    ...
    def _fix_date(raw: str) -> str:
        """2018-19 box scores have dates +1 year (Oct 2018 → 2019, Jan 2019 → 2020). Subtract 1."""
        parts = raw.split("/")
        if len(parts) == 3:
            try:
...
def main():
    parser = argparse.ArgumentParser(description="Generate 2018-19 team statistics from box scores")
