...
Reads box scores from '2021-22 Teams Schedules/<Team>/' and writes
aggregated stats to '2021-22 Team Statistics/<Team>/'.
...
SCHEDULES_DIR = Path("2021-22 Teams Schedules")
STATS_DIR = Path("2021-22 Team Statistics")
...
TEAM_ALIASES = {
    ...
    # Additional display-name variants found in 2021-22 box scores
    "East LA College": "East Los Angeles",
    "Fullterton College": "Fullerton",
