...
Reads box scores from '2019-20 Teams Schedules/<Team>/' and writes
aggregated stats to '2019-20 Team Statistics/<Team>/'.
...
SCHEDULES_DIR = Path("2019-20 Teams Schedules")
STATS_DIR = Path("2019-20 Team Statistics")
...
TEAM_ALIASES = {
    ...
    # Additional display-name variants found in 2019-20 box scores
...
def main():
    parser = argparse.ArgumentParser(description="Generate 2019-20 team statistics from box scores")
