...
Reads box scores from '2023-24 Teams Schedules/<Team>/' and writes
aggregated stats to '2023-24 Team Statistics/<Team>/'.

Usage:
    python generate_team_stats_2023.py --teams Moorpark Ventura
    python generate_team_stats_2023.py --all
"""
...
SCHEDULES_DIR = Path("2023-24 Teams Schedules")
STATS_DIR = Path("2023-24 Team Statistics")
...
TEAM_ALIASES = {
    ...
    # Additional display-name variants found in 2023-24 box scores
    "Coll. of the Siskiyo": "Siskiyous",
    "College of the Deser": "Desert",
    "East LA College": "East Los Angeles",
    "MTSANJAC": "Mt. San Jacinto",
    "RCC-M": "Riverside",
    "CHFY-M": "Chaffey",
    "GOLDEN~1": "Golden West",
    "LAHARBOR": "LA Harbor",
    "PVC-M": "Palo Verde",
    "PAS-M": "Pasadena City",
    "VENTUR~1": "Ventura",
    "BARSTOW": "Barstow",
    "SANTIAGO": "Santiago Canyon",
}
