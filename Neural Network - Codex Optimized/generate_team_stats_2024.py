...
Reads box scores from '2024-25 Teams Schedules/<Team>/' and writes
aggregated stats to '2024-25 Team Statistics/<Team>/'.
...
SCHEDULES_DIR = Path("2024-25 Teams Schedules")
STATS_DIR = Path("2024-25 Team Statistics")
...
TEAM_ALIASES = {
    ...
    # Additional aliases found in 2024-25 box scores
