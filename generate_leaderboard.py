...
function showGamePlan(teamName) {{
  ...
  games.forEach(gr => {{
    ...
    const rowBg = gr.result==='W' ? 'background:#e8f5e9' : (gr.result==='L' ? 'background:#fce8e8' : '');
